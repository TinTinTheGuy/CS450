...
Display( )
{
	...
	float nowTime = (float)msec / 4000;
	float TimeS = 0.1 * sin((nowTime) / 0.7);
	float TimeR = 0.1 * sin((nowTime * 5) / 2.f);

	switch (KeyTimesOn)
	{
		case 1:
			Pattern.SetUniformVariable("uSc", Sc.GetValue(Time));
			Pattern.SetUniformVariable("uTc", Tc.GetValue(Time));
			break;
		case 0:
			Pattern.SetUniformVariable("uSc", NowS0);
			Pattern.SetUniformVariable("uTc", NowT0);
			break;
	...
	switch (TimePattern)
	{
		case 1:
		{
			...
			Pattern.SetUniformVariable("uRs", TimeS);
			Pattern.SetUniformVariable("uRt", TimeR);
			break;
		}
		case 0:
...
InitGraphics( )
{
	...
	Sc.Init();
	Sc.AddTimeValue(0.0, 0.2);
	Sc.AddTimeValue(1.5, 0.6);
	Sc.AddTimeValue(3.0, 0.4);
	Sc.AddTimeValue(4.5, 0.8);
	Sc.AddTimeValue(7.0, 0.2);
	Sc.AddTimeValue(10.0, 0.9);

	Tc.Init();
	Tc.AddTimeValue(0.0, 0.8);
	Tc.AddTimeValue(1.5, 0.4);
	Tc.AddTimeValue(3.0, 0.6);
	Tc.AddTimeValue(4.5, 0.1);
	Tc.AddTimeValue(7.0, 0.9);
	Tc.AddTimeValue(10.0, 0.3);
