...
InitGraphics( )
{
	...
	Texture = BmpToTexture((char*)"sun.bmp", &width, &height);
	if (Texture == NULL)
	...
	// ======================================================================================
	// Mercury's texture:
	Texture = BmpToTexture((char*)"mercury.bmp", &width, &height);
	if (Texture == NULL)
		fprintf(stderr, "Cannot open texture '%s'\n", "2k_mercury.bmp");
	else
		fprintf(stderr, "Width = %d ; Height = %d\n", width, height);
	...
	// ======================================================================================
	// Earth's texture:
	Texture = BmpToTexture((char*)"earth.bmp", &width, &height);
	if (Texture == NULL)
		fprintf(stderr, "Cannot open texture '%s'\n", "worldtex.bmp");
	else
		fprintf(stderr, "Width = %d ; Height = %d\n", width, height);
	...
	// ======================================================================================
	// Mars' texture:
	Texture = BmpToTexture((char*)"mars.bmp", &width, &height);
	if (Texture == NULL)
		fprintf(stderr, "Cannot open texture '%s'\n", "2k_mars.bmp");
	else
		fprintf(stderr, "Width = %d ; Height = %d\n", width, height);
	...
	// ======================================================================================
	// Jupiter's texture:
	Texture = BmpToTexture((char*)"jupiter.bmp", &width, &height);
	if (Texture == NULL)
		fprintf(stderr, "Cannot open texture '%s'\n", "2k_jupiter.bmp");
	else
		fprintf(stderr, "Width = %d ; Height = %d\n", width, height);
	...
	// ======================================================================================
	// Saturn's texture:
	Texture = BmpToTexture((char*)"saturn.bmp", &width, &height);
	if (Texture == NULL)
		fprintf(stderr, "Cannot open texture '%s'\n", "2k_saturn.bmp");
	else
		fprintf(stderr, "Width = %d ; Height = %d\n", width, height);
	...
	// ======================================================================================
	// Uranus's texture:
	Texture = BmpToTexture((char*)"uranus.bmp", &width, &height);
	if (Texture == NULL)
		fprintf(stderr, "Cannot open texture '%s'\n", "2k_uranus.bmp");
	else
		fprintf(stderr, "Width = %d ; Height = %d\n", width, height);
	...
	// ======================================================================================
	// Neptune's texture:
	Texture = BmpToTexture((char*)"neptune.bmp", &width, &height);
	if (Texture == NULL)
		fprintf(stderr, "Cannot open texture '%s'\n", "2k_neptune.bmp");
	else
		fprintf(stderr, "Width = %d ; Height = %d\n", width, height);
